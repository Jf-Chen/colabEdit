...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='glofa_image2class', choices=['glofa'])
    parser.add_argument('--N', type=int, default=5)
    parser.add_argument('--K', type=int, default=5,choices=[1,5])
    parser.add_argument('--Q', type=int, default=10,choices=[15,10])
    # 加入DN4的最近邻 
    ...
    train_data_loader = Data.generate_data_loader(data_path, 'train', args.n_training_episodes, args.N, args.K + args.Q) # 原本是5-way 1-shot(5,1+15),改为5-way 5-shot(5,5+10)
    ...
    # generate model
    model = Model.MyModel(args, network)# glofa(args,resnet)
