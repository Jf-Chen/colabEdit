...
class MyModel(nn.Module):
    ...
    def forward(self, images):
        ...
        masked_support_embeddings = support_embeddings.view(self.args.K, self.args.N, -1)  #torch.Size([1, 5, 640])
        ...
        masked_query_embeddings = query_embeddings.unsqueeze(0).expand(self.args.N, -1, -1) # torch.Size([5, 75, 640])
